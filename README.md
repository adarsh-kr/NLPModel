...
1. adversarial finetune: python main.py -adv_train -wgt 1 1 -snapshot saved_model/base_model.pt

2. without adversarial: python main.py 

3. 

## TODOs

1. check whehter vocab indexing is constant 
